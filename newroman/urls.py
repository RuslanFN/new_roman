...
from shop.views import get_construct, user_login, user_logout, make_order, get_orders, remove_order, detail_order
...
urlpatterns = [
    ...
    path('orderdetail/', detail_order, name='orderdetail'),
